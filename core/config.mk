...
ifneq ($(BATIK_BUILD),)
include vendor/batik/config/BoardConfigBatik.mk
endif
...
ifneq ($(BATIK_BUILD),)
ifneq ($(wildcard device/batik/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/batik/sepolicy/common/sepolicy.mk)
endif
endif
